...
class EfficientNet(nn.Module):
    def __init__(
        ...
        # Before GAP
        self.ca_stream = CLS_Attention(lastconv_output_channels, heads=1,
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        x = self.features(x)
        attn, cls_tokens = self.ca_stream(x, cls_tokens)
...
dict_efficient_v1={'efficientnet_b0_v1': efficientnet_b0,
                   'efficientnet_b1_v1': efficientnet_b1}
