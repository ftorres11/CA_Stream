...
class ResNet(nn.Module):
    ...
    def __init__(self, block: Type[Union[BasicBlock, Bottleneck]],
        ...
        self.feed_forward = CLS_FeedForward(512*block.expansion,
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        cls_tokens = self.feed_forward(cls_tokens)
...
def resnet152(pretrained: bool = False, progress: bool = True,
              project: bool = False, asclassifier: bool = False,
              **kwargs: Any) -> ResNet:
...
def wide_resnet101_2(pretrained: bool = False, progress: bool = True,
                     project: bool = False, asclasifier:bool = False,
                     **kwargs: Any) -> ResNet:
...
# ========================================================================
dict_resnet_v2 ={'resnet18_v2': resnet18,
                 'resnet34_v2': resnet34,
                 'resnet50_v2': resnet50,
                 'resnet101_v2': resnet101,
                 'resnet152_v2': resnet152,
                 'resnext50_32x4d_v2': resnet.resnext50_32x4d,
                 'resnext101_32x8d_v2': resnext101_32x8d,
                 'wide_resnet50_2_v2': wide_resnet50_2,
                 'wide_resnet101_2_v2': wide_resnet101_2}
