...
# In package imports
from models.transformer import CLS_KV, Conv_Shared, Light_Shared
...
class ResNet(nn.Module):
    ...
    def __init__(self, block: Type[Union[BasicBlock, Bottleneck]],
        ...
        #self.bn_cls0 = nn.BatchNorm2d(64*block.expansion)
        #self.bn_cls1 = nn.BatchNorm2d(128*block.expansion)
        #self.bn_cls2 = nn.BatchNorm2d(256*block.expansion)
        #self.bn_cls3 = nn.BatchNorm2d(512*block.expansion)
    ...
    def _make_increasing(self, depth: int=512, dim_head: int=256,
                         ...
                         project: bool=True, scaling=512):
        if self.shared:
            layer = Conv_Shared(dim_head=dim_head, heads=heads,
                                project_out=project,
                                dropout=dropout)

        else:
            layer = CLS_KV(depth, heads=heads, dim_head=dim_head,
                           project_out=project,
                           ch_scaling=scaling,
                           dropout=dropout)
...
dict_clsv3 ={'resnet18_clsv3': resnet18,
             'resnet34_clsv3': resnet34,
             'resnet50_clsv3': resnet50,
             'resnet101_clsv3': resnet101
             }
# Add the rest should I use them
