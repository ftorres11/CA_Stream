...
# Felipe Torres Figueroa, felipe.torres@lis-lab.fr-felitf.94@gmail.com
...
# ========================================================================
def confinalx1(in_planes: int, out_planes: int, stride: int = 1) -> nn.Conv2d:
    """1x1 convolution"""
    ...
    def __init__(self, inplanes: int, planes: int, stride: int = 1,
        ...
        if dilation > 1:
            raise NotImplementedError("Dilation > 1 not supported in"\
                                      " BasicBlock")
        # Both self.confinal and self.downsample layers downsample the 
        # input when stride != 1
        self.override = False
        self.confinal = conv3x3(inplanes, planes, stride)
...
class Bottleneck(nn.Module):
    ...
    # stride at the first 1x1 convolution(self.confinal) according to "Deep
    # residual learning for image recognition" 
    # https://arxiv.org/abs/1512.03385 
    # This variant is also known as ResNet V1.5 and improves accuracy
    # according to
    # https://ngc.nvidia.com/catalog/model-scripts/nvidia:resnet_50_final_5_for_pytorch.
    ...
    def __init__(self, inplanes: int, planes: int, stride: int = 1,
        ...
        # input when stride != 1
        self.override = False
        self.confinal = confinalx1(inplanes, width)
        self.bn1 = norm_layer(width)
        self.conv2 = conv3x3(width, width, stride, groups, dilation)
        self.bn2 = norm_layer(width)
        self.conv3 = confinalx1(width, planes * self.expansion)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block: Type[Union[BasicBlock, Bottleneck]],
        ...
        self.confinal = nn.Conv2d(3, self.inplanes, kernel_size=7, padding=3,
                               stride=2, bias=False)
        ...
        self.cls_surrogate = CLS_Attention(512*block.expansion,
                                           heads=heads,
    ...
    def _make_layer(self, block: Type[Union[BasicBlock, Bottleneck]],
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                confinalx1(self.inplanes, planes * block.expansion, stride),
...
# ========================================================================
dict_resnet_final ={'resnet18_final': resnet18,
                'resnet34_final': resnet34,
                'resnet50_final': resnet50,
                'resnet101_final': resnet101,
                'resnet152_final': resnet152,
                'resnext50_32x4d_final': resnet.resnext50_32x4d,
                'resnext101_32x8d_final': resnext101_32x8d,
                'wide_resnet50_2_final': wide_resnet50_2,
                'wide_resnet101_2_final': wide_resnet101_2}
