...
# In package imports
from models.transformer import CLS_KV, Conv_Shared, CLS_FeedForward
...
class ResNet(nn.Module):
    ...
    def __init__(self, block: Type[Union[BasicBlock, Bottleneck]],
        ...
        if self.shared:
            ...
            self.cls_surrogate.to_out.append(\
...
# ========================================================================
dict_resnet_v4 ={'resnet18_v4': resnet18,
                'resnet34_v4': resnet34,
                'resnet50_v4': resnet50,
                'resnet101_v4': resnet101,
                'resnet152_v4': resnet152,
                'resnext50_32x4d_v4': resnext50_32x4d,
                'resnext101_32x8d_v4': resnext101_32x8d,
                'wide_resnet50_2_v4': wide_resnet50_2,
                'wide_resnet101_2_v4': wide_resnet101_2}
